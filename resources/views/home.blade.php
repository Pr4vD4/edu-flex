            ...
            <div class="text-center md:text-left" x-data="{ show: false }" x-init="setTimeout(() => show = true, 100)">
                <div x-show="show"
                    ...
                    <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">
                        Образование, которое <span class="text-blue-300">меняет жизнь</span>
                    </h1>
                    <p class="text-blue-100 text-lg md:text-xl max-w-xl">
                        Изучайте востребованные навыки с нашими экспертами и начните карьеру мечты
                    </p>
                    <div class="pt-4 flex flex-wrap gap-4 justify-center md:justify-start">
                        <a href="{{ route('courses.index') }}" class="px-6 py-3 bg-white text-blue-600 font-medium rounded-lg hover:bg-blue-50 transition shadow-md">
                            Начать обучение
                        </a>
...
<div class="bg-white py-16">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-gray-900 mb-4">Почему стоит учиться с нами</h2>
            <p class="text-gray-600 max-w-2xl mx-auto">Мы создали оптимальные условия для достижения максимальных результатов в обучении</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8" x-data="{ selected: null }">
            <div class="bg-white rounded-xl shadow-md p-6 transition duration-300 hover:shadow-lg"
                @mouseenter="selected = 1"
                @mouseleave="selected = null"
                :class="{ 'border-blue-500 border-2': selected === 1 }">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">Учитесь в любое время</h3>
                <p class="text-gray-600">Доступ к курсам 24/7 с любого устройства. Учитесь в удобном для вас темпе.</p>
            </div>

            <div class="bg-white rounded-xl shadow-md p-6 transition duration-300 hover:shadow-lg"
                @mouseenter="selected = 2"
                @mouseleave="selected = null"
                :class="{ 'border-blue-500 border-2': selected === 2 }">
                <div class="rounded-full bg-green-100 w-16 h-16 flex items-center justify-center mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                </div>
                <h3 class="text-xl font-bold text-gray-900 mb-2">Опытные преподаватели</h3>
                <p class="text-gray-600">Обучайтесь у профессионалов своего дела с многолетним опытом в индустрии.</p>
            </div>

            <div class="bg-white rounded-xl shadow-md p-6 transition duration-300 hover:shadow-lg"
                @mouseenter="selected = 3"
                @mouseleave="selected = null"
                :class="{ 'border-blue-500 border-2': selected === 3 }">
                <div class="rounded-full bg-purple-100 w-16 h-16 flex items-center justify-center mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                    </svg>
                </div>
                <h3 class="text-xl font-bold text-gray-900 mb-2">Сертификация</h3>
                <p class="text-gray-600">Получите сертификат об успешном окончании курса для вашего портфолио.</p>
            </div>
        </div>
    </div>
</div>
